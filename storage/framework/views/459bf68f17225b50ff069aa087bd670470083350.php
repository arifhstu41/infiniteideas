			...
			<div class="card border-0">
				...
				<div class="card-body pt-2">
					...
					<div class="col-md-12 col-sm-12 text-center mb-2">
						<a href="<?php echo e(route('admin.davinci.chats')); ?>" class="btn btn-cancel"><?php echo e(__('Return')); ?></a>
					</div>	
				</div>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/app.infiniteideas.ai/resources/views/admin/davinci/chats/category.blade.php ENDPATH**/ ?>