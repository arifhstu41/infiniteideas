	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#subscriptionsTable').DataTable({
				...
				"order": [[ 0, "desc" ]],
				language: {
					"emptyTable": "<div><br><?php echo e(__('There are no subscribers yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/app.infiniteideas.ai/resources/views/admin/finance/transactions/subscriptions.blade.php ENDPATH**/ ?>