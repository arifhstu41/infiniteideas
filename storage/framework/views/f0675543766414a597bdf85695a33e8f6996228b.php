...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											...
											<select id="paddle_sandbox" name="paddle_sandbox" class="form-select" data-placeholder="<?php echo e(__('Enable/Disable Paddle Sandbox')); ?>:">			
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/iyzico.svg')); ?>" alt="Midtrans" class="gateway-logo"><span class="text-primary">Iyzico</span> <?php echo e(__('Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>

								<div class="row">
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												<input type="checkbox" name="enable-iyzico" class="custom-switch-input" <?php if(config('services.iyzico.enable')  == 'on'): ?> checked <?php endif; ?>>
												<span class="custom-switch-indicator"></span>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">
										...
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['iyzico_api_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="iyzico_api_key" name="iyzico_api_key" value="<?php echo e(config('services.iyzico.api_key')); ?>" autocomplete="off">
											</div>
											<?php $__errorArgs = ['iyzico_api_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('iyzico_api_key')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">								
										...
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['iyzico_secret_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="iyzico_secret_key" name="iyzico_secret_key" value="<?php echo e(config('services.iyzico.secret_key')); ?>" autocomplete="off">
											</div> 
											<?php $__errorArgs = ['iyzico_secret_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('iyzico_secret_key')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											...
											<select id="iyzico_sandbox" name="iyzico_sandbox" class="form-select">			
												<option value=true <?php if(config('services.iyzico.sandbox')  == true): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
												<option value=false <?php if(config('services.iyzico.sandbox')  == false): ?> selected <?php endif; ?>><?php echo e(__('Disable')); ?></option>
											</select>
											<?php $__errorArgs = ['iyzico_sandbox'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('iyzico_sandbox')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											...
											<select id="midtrans-production" name="midtrans-production" class="form-select" data-placeholder="<?php echo e(__('Enable/Disable Midtrans Production')); ?>:">			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/app.infiniteideas.ai/resources/views/admin/finance/settings/index.blade.php ENDPATH**/ ?>