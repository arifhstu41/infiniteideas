						...
						<div class="row">		
							<div class="col-md-6 col-sm-12">							
								<div class="input-box">	
									...
									<select id="invoice-currency" name="invoice_currency" class="form-select" data-placeholder="<?php echo e(__('Select Currency')); ?>:">			
							...
							<div class="col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Invoice Language')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
			  						<select id="invoice-language" name="invoice_language" class="form-select" data-placeholder="<?php echo e(__('Select Language')); ?>:">			
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-md-4 col-sm-12">							
								<div class="input-box">	
									...
									<select id="invoice-country" name="invoice_country" class="form-select" data-placeholder="<?php echo e(__('Select Invoice Country')); ?>:">	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/app.infiniteideas.ai/resources/views/admin/finance/invoice/index.blade.php ENDPATH**/ ?>