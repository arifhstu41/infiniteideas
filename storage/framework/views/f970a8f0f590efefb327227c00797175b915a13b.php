										...
										<div id="audio-format" role="radiogroup">
											<span  id="webm-format">							
												<div class="radio-control">
													...
													<label for="concent" class="label-control text-muted fs-13" id="concent-label"><?php echo e(__('I confirm that I have read the Update tab in the documentation and will follow all steps there to finish the update')); ?> - <a class="font-weight-bold text-primary" target="_blank" href="https://openaidavinci.textract.ai/public/documentation/"><?php echo e(__('Documentation Link')); ?></a></label>
												</div>	
											</span>										
										</div>	
									</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/app.infiniteideas.ai/resources/views/admin/settings/upgrade/index.blade.php ENDPATH**/ ?>