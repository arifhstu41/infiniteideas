						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">				
								<div class="input-box">	
									...
									<select id="support-category" name="category" class="form-select" data-placeholder="<?php echo e(__('Select Support Case')); ?>:">			
...
unset($__errorArgs, $__bag); ?>	
							...
							<div class="col-lg-6 col-md-6 col-sm-12">						
								<div class="input-box">	
									...
									<select id="support-priority" name="priority" class="form-select" data-placeholder="<?php echo e(__('Select Support Case Priority')); ?>:">			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/app.infiniteideas.ai/resources/views/user/support/create.blade.php ENDPATH**/ ?>