...
class AppearanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (request()->has('main_logo')) {
            ...
            try{
                ...
                toastr()->error(__('Incorrect image format or file size, image must be in PNG format and less than 5MB').$e->getMessage());
    ...
    {
       echo $name = !is_null($filename) ? $filename : Str::random(5);
